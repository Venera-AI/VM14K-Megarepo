...
class PostgresService:
    ...
    @overload
    async def insert(self, repo: Type[PostgresRepo[T]], record: T | BaseDict, returning: bool) -> T | None: ...
    ...
    async def insert_many(
        self, repo: Type[PostgresRepo[T]], records: List[T] | List[BaseDict], returning: Literal[True]
    ) -> List[T]: ...

    @overload
    async def insert_many(
        self, repo: Type[PostgresRepo[T]], records: List[T] | List[BaseDict], returning: Literal[False]
    ) -> None: ...

    @overload
    async def insert_many(
        self, repo: Type[PostgresRepo[T]], records: List[T] | List[BaseDict], returning
    ) -> List[T] | None: ...

    @overload
    async def insert_many(self, repo: Type[PostgresRepo[T]], records: List[T] | List[BaseDict]) -> None: ...

    async def insert_many(
        self, repo: Type[PostgresRepo[T]], records: List[T] | List[BaseDict], returning: bool = False
    ) -> List[T] | None:
