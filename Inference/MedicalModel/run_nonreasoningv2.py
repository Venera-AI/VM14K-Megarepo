#!/usr/bin/env python3
"""
Multiple-choice question evaluation script using vLLM.
This script processes JSONL files containing questions and evaluates them using
...
def main():
    assert len(sys.argv) == 2, "Usage: python script.py <model_name>"
    model = sys.argv[1]
